...
<head runat="server">
    <style type="text/css">
       ...
       #first
       {
            background-color:rgba(255,255,255,.7);<%--#ffd84d--%>
            display:block; 
            text-align:center;  
            width:110px;
            margin-top:90px;
    ...
    <div class="wap">
                    ...
                    <ItemTemplate>
                        <div class="test">
                            <div class="hylint5">
                                <ul>
                                    <li>
                                        <asp:HyperLink ID="HyperLink2" runat="server" CssClass="hylint5" NavigateUrl='<%# "category.aspx?ca_id="+Eval("ca_id").ToString() %>'
        ...
        <div class="gouwuche">
            <asp:DataList ID="DataList1" runat="server" DataKeyField="productid" RepeatColumns="7"
                OnUpdateCommand="DataList1_UpdateCommand" BackColor="#F1F1F1" EnableViewState="False">
                <ItemTemplate>
                    <div class="shop" style="text-align: center;">
                        ...
                        <div class="second_img">
                            <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/images/shoppingcart.gif"
                                CommandName="Update" CausesValidation="False" Visible="False" />
                        </div>
                    </div>
                </ItemTemplate>
            </asp:DataList>
