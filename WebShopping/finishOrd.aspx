<%@ Page Language="C#" AutoEventWireup="true" CodeFile="finishOrd.aspx.cs" Inherits="finishOrd" %>
...
<body>
    ...
    <div class="header">
        <ul class="head_ul">
            ...
            <li><a href="cartBasket.aspx">
                ...
                <a href="#">&nbsp;</a></li>
            <li><a href="#"><asp:LinkButton ID="LinkButton2" runat="server" 
                    onclick="LinkButton2_Click">用户登出</asp:LinkButton>
               </a></li>
    ...
    <div>
        ...
        地址：<asp:AccessDataSource ID="AccessDataSource1" runat="server" 
            DataFile="~/App_Data/mystore.mdb" 
            SelectCommand="SELECT * FROM [yonghu] WHERE ([userName] = ?)">
            <SelectParameters>
                <asp:SessionParameter Name="userName" SessionField="cartname" Type="String" />
            </SelectParameters>
        </asp:AccessDataSource>
        <asp:FormView ID="FormView2" runat="server" DataSourceID="AccessDataSource1">
            ...
            <ItemTemplate>
            <div class="addre">
                地址：<asp:Label ID="addressLabel" runat="server" Text='<%# Eval("address") %>' />
                <br />
                电话：<asp:Label ID="phone" runat="server" Text='<%# Eval("phone") %>'></asp:Label>
                </div>
            </ItemTemplate>
        </asp:FormView>
        <asp:AccessDataSource ID="AccessDataSource2" runat="server" 
            DataFile="~/App_Data/mystore.mdb" 
            SelectCommand="SELECT DISTINCT * FROM [temp] WHERE ([cartCustomer] = ?)">
            <SelectParameters>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="Label1" runat="server" 
                                Text='<%# Convert.ToInt32((Eval("UnitPrice")))*Convert.ToInt32((Eval("Quantity"))) %>'></asp:Label>
                        </td>
                    </tr>
                </table>
                <br />
      ...
      <div class="jiesuan">
        总价:<asp:Label ID="zj" runat="server" Text="0"></asp:Label><br />
       快递费:<asp:Label ID="kdf" runat="server" Text="0"></asp:Label><br />
        付款:<asp:Label ID="fk" 
            runat="server" Text="0"></asp:Label>
        <br />
        <asp:LinkButton ID="LinkButton1" runat="server" onclick="LinkButton1_Click">完成订单</asp:LinkButton>
    </div>
